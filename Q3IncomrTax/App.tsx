...
const App = () => {
  ...
  const calculateTax = () => {
    ...
    let taxAmount = 0;
    if (incomeAmount <= 10_000_000) {
      taxAmount = incomeAmount * 0.1;
    } else if (incomeAmount <= 50_000_000) {
      taxAmount = 10_000_000 * 0.1 + (incomeAmount - 10_000) * 0.2;
    }else {
      taxAmount = 10_000_000 * 0.1 + 40_000_000 * 0.2 + (incomeAmount - 50_000_000) * 0.3;
    }
